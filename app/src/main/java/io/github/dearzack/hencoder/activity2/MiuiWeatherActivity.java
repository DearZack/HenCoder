...
import io.github.dearzack.hencoder.bean.WeatherBean;
import io.github.dearzack.hencoder.view2.MiuiWeatherView;

public class MiuiWeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_miui_weather);
